    ...
    <section id="tools" className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
          {/* Card A: PlanBoard */}
          <div className="bg-white rounded-xl p-6 lg:p-8 border border-gray-200 shadow-md hover:shadow-xl transition-shadow">
            ...
            {/* ミニモック */}
            <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-3 text-sm border border-gray-200">
              <div>
          ...
          <div className="bg-white rounded-xl p-6 lg:p-8 border border-gray-200 shadow-md hover:shadow-xl transition-shadow">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-3 text-sm border border-gray-200">
              <div>
                <div className="text-gray-600 text-xs mb-1">予算：〜万円</div>
                <div className="text-gray-600 text-xs mb-1">エリア：千葉/東京/その他</div>
                <div className="text-gray-600 text-xs mb-1">人数：〜人</div>
                <div className="text-gray-600 text-xs">重視：料理 / 写真 / 雰囲気 / 価格 / 自由度</div>
              </div>
              <div className="pt-3 border-t border-gray-300">
          ...
          <div className="bg-white rounded-xl p-6 lg:p-8 border border-gray-200 shadow-md hover:shadow-xl transition-shadow">
            ...
            {/* 当日対応リスト */}
            <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-2 text-sm border border-gray-200">
